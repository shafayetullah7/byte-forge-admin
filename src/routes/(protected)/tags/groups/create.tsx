                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
                        ...
                        <div class="xl:col-span-7 flex flex-col gap-6">
                            <Card class="p-6">
                                ...
                                {/* Hidden Locales to satisfy Zod schema */}
                                <Field name="translations.0.locale">
                                    {(field, fieldProps) => <input {...fieldProps} type="hidden" value="en" />}
                                </Field>
                                <Field name="translations.1.locale">
                                    {(field, fieldProps) => <input {...fieldProps} type="hidden" value="bn" />}
                                </Field>

                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-6">
                                    {/* --- Left Column (English & Base Details) --- */}
                                    <div class="space-y-6">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <Field name="isActive" type="boolean">
                                            {(field, fieldProps) => (
                                                <div class="flex items-center justify-between p-4 rounded-lg border border-slate-100 bg-slate-50/50 h-[72px]">
                                                    <div>
                                            ...
                                            {(field, fieldProps) => (
                                                <div class="space-y-2">
                                                    ...
                                                    <textarea
                                                        ...
                                                        rows={4}
                                                        class="block w-full rounded-lg border bg-white px-3 py-2.5 text-sm ring-offset-white transition-all focus:border-primary-green-500 focus:outline-none focus:ring-2 focus:ring-primary-green-500/20 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-500 border-slate-200"
                                                        placeholder="এই ট্যাগ গ্রুপের সংক্ষিপ্ত বিবরণ..."
                                                        value={field.value || ""}
                                                        maxLength={1000}
                                                        disabled={isPending()}
                                                    />
                        ...
                        <div class="xl:col-span-5 flex flex-col gap-6">
                            <Card class="p-6">
                                ...
                                {/* Tags Builder Toolbar */}
                                <div class="p-4 rounded-xl border border-slate-200 bg-slate-50/50 mb-6">
                                    <div class="flex flex-col sm:flex-row flex-wrap gap-3 items-end">
                                        ...
                                        <Button
                                            ...
                                            class="h-10 w-full lg:w-auto px-6 whitespace-nowrap shadow-sm hover:shadow-md transition-shadow"
                                        >
                                            + Add Tag
                                        </Button>
                                    </div>
